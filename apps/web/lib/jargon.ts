...
export const jargonDictionary: Record<string, JargonTerm> = {
  ...
  flywheel: {
    ...
    analogy: "Imagine a snowball rolling downhill. As it rolls, it picks up more snow, which makes it heavier, which gives it more momentum, which helps it pick up even more snow. Success breeds success. The Agent Flywheel works the same way: better tools enable better AI work, which produces better results, which justifies investing in even better tools. Each improvement compounds.",
